...
void app_main(void) {
    ...
    if (wait_for_boot_button()) {
        ...
        // Boot button was NOT pressed - check device role and fork execution
        ESP_LOGI(TAG, "Checking device role for normal operation...");
        ...
        // Fork execution based on device role
