...
# Also run the copy operation immediately when this script is loaded
# This ensures files are copied even when no build occurs
copy_firmware_files(None, None, env)

# Register the post-build action for multiple targets to ensure it runs
